...
The pension calculator UI has been broken down into the following reusable
components:
...
- **Props**: `label`, `value`, `onChange`, `min`, `max`, `step`, `formatter`,
  `description`
...
- **YourDecisionsTab**: Contributions, retirement age, drawdown with
  optimization tips
